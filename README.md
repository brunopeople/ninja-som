...
🌟 Antes de tudo, me ajuda aí. Deu um trabalhão organizar todos esses links 🌟
  
</div>

👨🏻‍💻 [Me segue no GitHub](https://github.com/arthurspk/ "GitHub")<br> 
💻 [Entra no servidor do discord para mais conteúdo](https://discord.gg/NbMQUPjHz7 "Discord") <br> 
🌈 [Conecta lá no Linkedin](https//www.linkedin.com/in/arthurspk/ "Linkedin") <br> 

# 📑 Índice
* [Programação em Geral](#programacaoEmGeral)
    * [Sites Para Estudar Programação](#sitesParaEstudarProgramacao)  
    * [Sites Para Aprender A Programar Jogando](#installation) 
    * [Ótimos Sites Para Desenvolvedores](#installation)
    * [Ferramentas Para Buscar Projetos Open Source](#installation) 
    * [7 Ferramentas Para Que Todo Dev Precisa Conhecer](#installation) 
    * [Ferramentas Para Hospedar Seu Site De Graça](#installation) 
    * [Canais Do Youtube Com Conteúdo Gratuito](#installation) 
    * [Blogs E Podcasts](#installation) 
    * [Web Developer Roadmap](#installation) 
    * [Extensões Para O Seu Navegador](#installation) 
    * [Recomendação De Livros](#installation) 
    * [Apps Para Praticar Programação](#installation) 
    * [Sites Para Treinar Projetos Mobile](#installation) 
    * [Ideias Para Projeto](#installation) 
* [Front-end](#frontEnd)
    * [Sites Para Desenvolvedor Front-end](#installation) 
    * [Templates Html Gratuitos](#installation) 
    * [Sites Para Aprender Ou Treinar Css](#installation) 
    * [Geradores De Css](#installation) 
    * [Ferramentas Para Dev Web](#installation)
    * [Sites Para Treinar Projetos Front-end (montar Portfolio)](#installation) 
    * [Css3](#installation) 
    * [Curso De React](#installation) 
    * [Curso De Angular](#installation) 
    * [Curso De React Native](#installation) 
    * [Curso De Vue](#installation) 
    * [Curso De Less](#installation) 
    * [Curso De Sass](#installation) 
    * [Curso De Bootstrap](#installation) 
    * [Curso De Jquery](#installation) 
    * [Curso De Html & Css](#installation) 
        * [Design](#design) 
            * [Sites Para Praticar Ui/ux](#installation) 
            * [Sites Para Inspirar O Seu Desenvolvimento](#installation) 
            * [Sites Para Baixar E Encontrar Fontes](#installation) 
            * [Site De De Paletas De Cores](#installation) 
            * [Lista De Ilustrações](#installation) 
            * [Site De Icones](#installation)
* [Back-end](#backEnd)
    * [Melhores Distros Linux Para Programadores](#installation) 
    * [Sites Para Treinar Projetos Back-end](#installation) 
    * [Cursos De Java](#installation) 
    * [Curso De Python](#installation) 
    * [Python 3 Completo Curso Em Video](#installation) 
    * [Curso De Svelte](#installation) 
    * [Curso De Php](#installation) 
    * [Curso De Flutter](#installation) 
    * [Curso De Kotlin](#installation) 
    * [Curso De Go (golang)](#installation) 
    * [Curso De Ruby](#installation) 
    * [Curso C++](#installation) 
    * [Curso De Swift](#installation) 
    * [Curso De C](#installation) 
    * [Curso De Php](#installation) 
* [JavaScript](#js)
    * [Bibliotecas Javascript](#installation) 
    * [Curso De Java-Script](#installation) 
* [Vagas de emprego](#vagasDeEmprego) 
    * [Site Para Buscar Vagas Remotas](#installation) 
* [Git E Github](#installation) 

## <a name="sitesParaEstudarProgramacao"> 📚 SITES PARA ESTUDAR PROGRAMAÇÃO: </a>
...
## 📚 <a name="sitesParaEstudarProgramacao"> SITES PARA DESENVOLVEDOR FRONT-END: </a>
...
## 📚 <a name="sitesParaAprenderAProgramarJogando"> SITES PARA APRENDER A PROGRAMAR JOGANDO: </a>
...
## 📚 <a name="templatesHtmlGratuitos"> TEMPLATES HTML GRATUITOS: </a>
...
## 📚 <a name="sitesParaAprenderOuTreinarCss"> SITES PARA APRENDER OU TREINAR CSS: </a>
...
## 📚 <a name="geradoresDeCss"> GERADORES DE CSS: </a>
...
## 📚 <a name="sitesParaBuscarVagasRemotas"> SITES PARA BUSCAR VAGAS REMOTAS: </a>
...
## 📚 <a name="siteParaEstudarProgramacao"> ÓTIMOS SITES PARA DESENVOLVEDORES: </a>
...
## 📚 <a name="siteParaEstudarProgramacao"> FERRAMENTAS PARA DEV WEB: </a>

🔖 https://www.minimamente.com/project/magic/ <br>
🔖 https://jonsuh.com/hamburgers/ <br>
🔖 https://ianlunn.github.io/Hover/ <br>

## 📚 <a name="siteParaEstudarProgramacao"> FERRAMENTAS PARA BUSCAR PROJETOS OPEN SOURCE: </a>
...
## 📚 <a name="siteParaEstudarProgramacao"> MELHORES DISTROS LINUX PARA PROGRAMADORES: </a>
...
## 📚 <a name="siteParaEstudarProgramacao"> BIBLIOTECAS JAVASCRIPT: </a>
...
## 📚 <a name="siteParaEstudarProgramacao"> 7 FERRAMENTAS PARA QUE TODO DEV PRECISA CONHECER: </a>
...
## 📚 <a name="siteParaEstudarProgramacao"> SITES PARA PRATICAR UI/UX: </a>
...
## 📚 <a name="siteParaEstudarProgramacao"> FERRAMENTAS PARA HOSPEDAR SEU SITE DE GRAÇA: </a>
...
## 📚 <a name="siteParaEstudarProgramacao"> SITES PARA INSPIRAR O SEU DESENVOLVIMENTO: </a>
...
## 📚 <a name="siteParaEstudarProgramacao"> SITES PARA BAIXAR E ENCONTRAR FONTES: </a>
...
## 📚 <a name="siteParaEstudarProgramacao"> SITE DE DE PALETAS DE CORES: </a>
...
## 📚 <a name="siteParaEstudarProgramacao"> LISTA DE ILUSTRAÇÕES: </a>
...
## 📚 <a name="siteParaEstudarProgramacao"> SITE DE ICONES: </a>
...
## 📚 <a name="siteParaEstudarProgramacao"> CANAIS DO YOUTUBE COM CONTEÚDO GRATUITO: </a>
...
## 📚 <a name="siteParaEstudarProgramacao"> BLOGS E PODCASTS: </a>
...
## 📚 <a name="siteParaEstudarProgramacao"> WEB DEVELOPER ROADMAP: </a>

🔖 https://github.com/kamranahmedse/developer-roadmap <br>

## 📚 <a name="siteParaEstudarProgramacao"> EXTENSÕES PARA O SEU NAVEGADOR: </a>
...
## 📚 <a name="siteParaEstudarProgramacao"> RECOMENDAÇÃO DE LIVROS: </a>
...
## 📚 <a name="siteParaEstudarProgramacao"> APPS PARA PRATICAR PROGRAMAÇÃO: </a>
...
## 📚 <a name="siteParaEstudarProgramacao"> SITES PARA TREINAR PROJETOS FRONT-END (MONTAR PORTFOLIO): </a>
...
## 📚 <a name="siteParaEstudarProgramacao"> SITES PARA TREINAR PROJETOS BACK-END: </a>

🔖 https://devchallenge.vercel.app/challenges?type=backend <br>

## 📚 <a name="siteParaEstudarProgramacao"> SITES PARA TREINAR PROJETOS MOBILE: </a>

🔖 https://devchallenge.vercel.app/challenges?type=mobile <br>

## 📚 <a name="siteParaEstudarProgramacao"> IDEIAS PARA PROJETO: </a>

🔖 https://github.com/florinpop17/app-ideas <br>
🔖 https://what-to-code.com/ <br>

## 📚 <a name="siteParaEstudarProgramacao"> CURSOS DE JAVA: </a>
...
## 📚 <a name="siteParaEstudarProgramacao"> CURSO DE JAVA SCRIPT: </a>
...
## 📚 <a name="siteParaEstudarProgramacao"> CURSO DE HTML & CSS: </a>
...
## 📚 <a name="siteParaEstudarProgramacao"> CURSO DE PYTHON: </a>
...
## 📚 <a name="siteParaEstudarProgramacao"> CURSO DE PHP: </a>
...
## 📚 <a name="siteParaEstudarProgramacao"> CURSO DE C#: </a>
...
## 📚 <a name="siteParaEstudarProgramacao"> CURSO C++
...
## 📚 <a name="siteParaEstudarProgramacao"> CURSO DE KOTLIN: </a>
...
## 📚 <a name="siteParaEstudarProgramacao"> CURSO DE SWIFT: </a>
...
## 📚 <a name="siteParaEstudarProgramacao"> CURSO DE GO (GOLANG): </a>

🔖 Curso de GO: https://youtube.com/playlist?list=PLCKpcjBB_VlBsxJ9IseNxFllf-UFEXOdg

## 📚 <a name="siteParaEstudarProgramacao"> CURSO DE RUBY: </a>
...
## 📚 <a name="siteParaEstudarProgramacao"> CURSO DE REACT: </a>
...
## 📚 <a name="siteParaEstudarProgramacao"> CURSO DE REACT NATIVE: </a>

🔖 Curso de React Native 1: https://www.youtube.com/playlist?list=PLx4x_zx8csUgyDN7j9L7gykBjxByM_etD <br>

## 📚 <a name="siteParaEstudarProgramacao"> CURSO DE ANGULAR: </a>
...
## 📚 <a name="siteParaEstudarProgramacao"> CURSO DE VUE: </a>
...
## 📚 <a name="siteParaEstudarProgramacao"> CURSO DE SVELTE: </a>

🔖 Curso Intensivo de Svelte: https://www.cod3r.com.br/courses/svelte-intensivo <br>

## 📚 <a name="siteParaEstudarProgramacao"> CURSO DE FLUTTER: </a>
...
## 📚 <a name="siteParaEstudarProgramacao"> CURSO DE JQUERY: </a>

🔖 Curso Completo de jQuery (56 aulas): https://goo.gl/tHdIZ7 <br>

## 📚 <a name="siteParaEstudarProgramacao"> CURSO DE LESS: </a>

🔖 Curso de Less (6 aulas): https://goo.gl/Y5UkLQ <br>

## 📚 <a name="siteParaEstudarProgramacao"> CURSO DE SASS: </a>

🔖 Curso de Sass (18 aulas) /Inglês/: https://goo.gl/DzRv1e <br>

## 📚 <a name="siteParaEstudarProgramacao"> CURSO DE BOOTSTRAP: </a>

🔖 Curso de Bootstrap (16 aulas): https://goo.gl/xFDOxT <br>

## 📚 <a name="siteParaEstudarProgramacao"> GIT E GITHUB: </a>
